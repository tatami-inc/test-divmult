...
```
$ ./build/normalize
log1p(x / f) / M:   0.0603784 ± 0.000133809
log1p(x * r) * N:   0.0546123 ± 0.000144244
log2(x / f + 1):    0.0523682 ± 5.85398e-05
log2(x * r + 1):    0.0448984 ± 6.94794-05
log(x / f + 1) / M: 0.0518799 ± 0.000129268
log(x * r + 1) * N: 0.0447853 ± 7.38861e-05
```
